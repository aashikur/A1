###  টাইপসক্রিপ্ট টিপস – Interface vs Type 
```
## Interface vs Type
...
- Extend করা: Interface সহজেই অন্য interface থেকে extend করা যায়। Type ও extend/union করা যায়, তবে syntax আলাদা।
...
উত্তর:
`keyof` দিয়ে আমরা একটি **object type-এর সব key-এর union type** তৈরি করতে পারি।
এটি type-safe code লিখতে খুবই কাজে লাগে।
...
const key: UserKeys = "name"; // ✅ ঠিক আছে
